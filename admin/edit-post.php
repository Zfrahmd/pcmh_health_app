...
<section class="form__section">
    <div class="container form__section-container">
        <h2 class="text-center mt-5">Edit Article</h2>
        <form class="centered_form" action="<?= ROOT_URL ?>admin/edit-post-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <select name="category_id" class="form-select form-select-sm">
                ...
                <option value="<?= $category['id']?>"<?php if($category['id'] == $category_id) echo 'selected="selected"' ?>><?= $category['title'] ?></option>
                <?php endwhile ?>
            </select>
